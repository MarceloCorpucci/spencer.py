Feature: Web Portal
  The Web portal is one of the UIs availables to manage what Spencer can do. On one hand, it allows to see
  ...
  Scenario: User creates a view
    ...
    * The view should contain the state of the executions.